...
export default function SettingsScreen() {
  const { sound, haptics, notifications, set: preference } = usePreferences();
  const setSound = (v: boolean) => preference("sound", v);
  const setHaptics = (v: boolean) => preference("haptics", v);
  const setNotifications = (v: boolean) => preference("notifications", v);
    ...
    >
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
        {Object.entries({
          ...
          <Pressable
            key={code}
            onPress={() => preference("locale", code)}
      ...
      <View style={styles.dangerZone}>
        ...
        <Text style={styles.dangerCopy}>
          Your profile and social content will be removed. Auditable game,
          referral, and transaction records stay pseudonymous.
        </Text>
        ...
        <Pressable
          ...
          style={({ pressed }) => [
            ...
            (confirmation !== "DELETE" || (!user?.isGuest && !password)) &&
              styles.disabled,
          ]}
        >
